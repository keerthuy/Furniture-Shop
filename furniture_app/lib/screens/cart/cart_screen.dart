          ...
          if (cart.items.isEmpty) {
            return Center(
              child: Column(
                ...
                children: [
                  Icon(Icons.shopping_cart_outlined, size: 80, color: AppTheme.border),
                  const SizedBox(height: 16),
                  const Text('Your cart is empty', style: TextStyle(fontSize: 18, color: AppTheme.grey)),
                  const SizedBox(height: 16),
                  ElevatedButton(
          ...
          return Column(
            children: [
                  ...
                  itemBuilder: (_, i) {
                    ...
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [BoxShadow(color: AppTheme.dark.withOpacity(0.05), blurRadius: 8)],
                      ),
                      child: Row(
                        children: [
                          ClipRRect(
                            ...
                            child: item.imageUrl.isNotEmpty
                                ...
                                : Container(width: 80, height: 80, color: AppTheme.border,
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: AppTheme.white,
                  boxShadow: [BoxShadow(color: AppTheme.dark.withOpacity(0.08), blurRadius: 10, offset: const Offset(0, -2))],
                ),
                child: SafeArea(
                  child: Row(
                    children: [
                      Column(
                        ...
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          const Text('Total', style: TextStyle(fontSize: 13, color: AppTheme.grey)),
