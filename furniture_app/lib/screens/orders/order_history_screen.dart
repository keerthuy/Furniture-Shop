...
class _OrderHistoryScreenState extends State<OrderHistoryScreen> {
  ...
  Color _statusColor(String status) {
    switch (status) {
      ...
      case 'Processing': return AppTheme.secondary;
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  const Text('No orders yet', style: TextStyle(fontSize: 18, color: AppTheme.grey)),
                  const SizedBox(height: 16),
                  ElevatedButton(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              const Spacer(),
                              Text('₹${order.totalPrice.toStringAsFixed(0)}', style: const TextStyle(
