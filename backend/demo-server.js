...
const products = [
  { _id: 'p1', name: 'Modern Sofa Set', description: 'Elegant 3-seater sofa with premium fabric upholstery. Perfect for modern living rooms with its clean lines and comfortable cushions.', price: 45000, images: [{ public_id: 'sofa1', url: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=800' }], category: 'Living Room', stock: 12, sellerId: { _id: 'u2', name: 'Seller One' }, ratings: 4.5, numReviews: 23, createdAt: new Date() },
  { _id: 'p2', name: 'Wooden Dining Table', description: 'Solid oak dining table seating 6. Hand-crafted with natural wood grain finish. Includes protective coating for durability.', price: 32000, images: [{ public_id: 'dining1', url: 'https://images.unsplash.com/photo-1617806118233-18e1de247200?w=800' }], category: 'Dining', stock: 8, sellerId: { _id: 'u2', name: 'Seller One' }, ratings: 4.2, numReviews: 15, createdAt: new Date() },
  { _id: 'p3', name: 'King Size Bed Frame', description: 'Luxurious king-size bed frame in walnut finish. Features solid wood construction with upholstered headboard.', price: 55000, images: [{ public_id: 'bed1', url: 'https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?w=800' }], category: 'Bedroom', stock: 5, sellerId: { _id: 'u2', name: 'Seller One' }, ratings: 4.8, numReviews: 31, createdAt: new Date() },
  { _id: 'p4', name: 'Ergonomic Office Chair', description: 'High-back ergonomic chair with lumbar support, adjustable armrests, and breathable mesh back. Ideal for long working hours.', price: 18500, images: [{ public_id: 'chair1', url: 'https://images.unsplash.com/photo-1592078615290-033ee584e267?w=800' }], category: 'Office', stock: 20, sellerId: { _id: 'u2', name: 'Seller One' }, ratings: 4.6, numReviews: 42, createdAt: new Date() },
  { _id: 'p5', name: 'Bookshelf Cabinet', description: 'Tall bookshelf with 5 tiers and cabinet storage at bottom. Made from engineered wood with oak veneer finish.', price: 12000, images: [{ public_id: 'shelf1', url: 'https://images.unsplash.com/photo-1594620302200-9a762244a156?w=800' }], category: 'Storage', stock: 15, sellerId: { _id: 'u2', name: 'Seller One' }, ratings: 4.0, numReviews: 8, createdAt: new Date() },
  { _id: 'p6', name: 'Garden Patio Set', description: 'Weather-resistant outdoor patio set with 4 chairs and 1 table. Made from UV-protected rattan with comfortable cushions.', price: 28000, images: [{ public_id: 'patio1', url: 'https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?w=800' }], category: 'Outdoor', stock: 6, sellerId: { _id: 'u2', name: 'Seller One' }, ratings: 4.3, numReviews: 11, createdAt: new Date() },
  { _id: 'p7', name: 'Kitchen Island Cart', description: 'Mobile kitchen island with granite top, 2 drawers, and towel rack. Locking wheels for stability.', price: 22000, images: [{ public_id: 'kitchen1', url: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=800' }], category: 'Kitchen', stock: 10, sellerId: { _id: 'u2', name: 'Seller One' }, ratings: 4.1, numReviews: 6, createdAt: new Date() },
  { _id: 'p8', name: 'Decorative Floor Lamp', description: 'Modern tripod floor lamp with linen shade. Adjustable height. Warm ambient lighting for any room.', price: 5500, images: [{ public_id: 'lamp1', url: 'https://images.unsplash.com/photo-1507473885765-e6ed057ab6fe?w=800' }], category: 'Decor', stock: 25, sellerId: { _id: 'u2', name: 'Seller One' }, ratings: 4.7, numReviews: 19, createdAt: new Date() },
  { _id: 'p9', name: 'Kids Study Desk', description: 'Colorful adjustable-height study desk for children aged 5-15. Includes pencil holder and book shelf.', price: 8500, images: [{ public_id: 'kids1', url: 'https://images.unsplash.com/photo-1544457070-4cd773b4d71e?w=800' }], category: 'Kids', stock: 18, sellerId: { _id: 'u2', name: 'Seller One' }, ratings: 4.4, numReviews: 13, createdAt: new Date() },
  { _id: 'p10', name: 'Bathroom Vanity Cabinet', description: 'Wall-mounted bathroom vanity with mirror, sink, and storage. Waterproof finish with soft-close drawers.', price: 16000, images: [{ public_id: 'bath1', url: 'https://images.unsplash.com/photo-1552321554-5fefe8c9ef14?w=800' }], category: 'Bathroom', stock: 7, sellerId: { _id: 'u2', name: 'Seller One' }, ratings: 4.2, numReviews: 9, createdAt: new Date() },
];
